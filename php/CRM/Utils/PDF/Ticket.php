...
class CRM_Utils_PDF_Ticket extends TCPDF {
   ...
   * Generator function
   */
  public function generateTicket($text) {
   ...
   */
  public function AddPdfLabel($text) {
   ...
   */
  public function setFormat(&$format, $unit) {
  ...
  public function setGenerator($objectinstance, $methodname = 'generateTicket') {
